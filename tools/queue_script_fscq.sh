...
# Initial timestamp
echo "Job with ID $SLURM_JOBID FQ-$1-$2 started at $(date)"

#Job steps
eval "$(conda shell.bash hook)"
conda activate scipion3
cmmd="srun --job-name=FQ-$1-$2 python3 /home/bioinfo/services/emv/tools/script_execute_fscq.py -i $1 -p $2"
echo $cmmd
...
# Final timestamp
echo "Job with ID $SLURM_JOBID FQ-$1-$2 ended at $(date)"

...
# Initial timestamp
echo "Job with ID $SLURM_JOBID MR-$1-$2 started at $(date)"

#Job steps
eval "$(conda shell.bash hook)"
conda activate scipion3
cmmd="srun --job-name=MR-$1-$2 python /home/bioinfo/services/emv/tools/script_execute_monores.py -i $1 -p $2"
echo $cmmd
$cmmd


# Final timestamp
echo "Job with ID $SLURM_JOBID MR-$1-$2 ended at $(date)"
